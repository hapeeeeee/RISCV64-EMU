...
static FORCE_INLINE inst_t inst_utype_read(uint32_t data) {
    return (inst_t){
...
static FORCE_INLINE inst_t inst_itype_read(uint32_t data) {
    return (inst_t){
        .imm = (int32_t)data >> 20,
        .rs1 = RS1(data),
        .rd = RD(data),
...
static FORCE_INLINE inst_t inst_jtype_read(uint32_t data) {
...
static FORCE_INLINE inst_t inst_btype_read(uint32_t data) {
...
static FORCE_INLINE inst_t inst_rtype_read(uint32_t data) {
    return (inst_t){
        .rs1 = RS1(data),
        .rs2 = RS2(data),
        .rd = RD(data),
...
static FORCE_INLINE inst_t inst_stype_read(uint32_t data) {
...
static FORCE_INLINE inst_t inst_csrtype_read(uint32_t data) {
    return (inst_t){
        .csr = data >> 20,
        .rs1 = RS1(data),
        .rd = RD(data),
...
static FORCE_INLINE inst_t inst_fprtype_read(uint32_t data) {
    return (inst_t){
        .rs1 = RS1(data),
        .rs2 = RS2(data),
        .rs3 = RS3(data),
...
static FORCE_INLINE inst_t inst_catype_read(uint16_t data) {
    return (inst_t){
        .rd = RP1(data) + 8,
        .rs2 = RP2(data) + 8,
        .rvc = true,
...
static FORCE_INLINE inst_t inst_crtype_read(uint16_t data) {
    return (inst_t){
        .rs1 = RC1(data),
        .rs2 = RC2(data),
        .rvc = true,
...
static FORCE_INLINE inst_t inst_citype_read(uint16_t data) {
...
static FORCE_INLINE inst_t inst_citype_read2(uint16_t data) {
...
static FORCE_INLINE inst_t inst_citype_read3(uint16_t data) {
...
static FORCE_INLINE inst_t inst_citype_read4(uint16_t data) {
    uint32_t imm5 = (data >> 12) & 0x1;
...
static FORCE_INLINE inst_t inst_citype_read5(uint16_t data) {
...
static FORCE_INLINE inst_t inst_cbtype_read(uint16_t data) {
    uint32_t imm5 = (data >> 2) & 0x1;
...
static FORCE_INLINE inst_t inst_cbtype_read2(uint16_t data) {
    uint32_t imm40 = (data >> 2) & 0x1f;
    uint32_t imm5 = (data >> 12) & 0x1;
    int32_t imm = (imm5 << 5) | imm40;
    imm = (imm << 26) >> 26;
...
static FORCE_INLINE inst_t inst_cstype_read(uint16_t data) {
    uint32_t imm76 = (data >> 5) & 0x3;
...
static FORCE_INLINE inst_t inst_cstype_read2(uint16_t data) {
    uint32_t imm6 = (data >> 5) & 0x1;
...
static FORCE_INLINE inst_t inst_cjtype_read(uint16_t data) {
    uint32_t imm5 = (data >> 2) & 0x1;
...
static FORCE_INLINE inst_t inst_cltype_read(uint16_t data) {
    uint32_t imm6 = (data >> 5) & 0x1;
    uint32_t imm2 = (data >> 6) & 0x1;
    uint32_t imm53 = (data >> 10) & 0x7;
...
static FORCE_INLINE inst_t inst_cltype_read2(uint16_t data) {
    uint32_t imm76 = (data >> 5) & 0x3;
    uint32_t imm53 = (data >> 10) & 0x7;
...
static FORCE_INLINE inst_t inst_csstype_read(uint16_t data) {
...
static FORCE_INLINE inst_t inst_csstype_read2(uint16_t data) {
...
static FORCE_INLINE inst_t inst_ciwtype_read(uint16_t data) {
...
void decode_inst(inst_t *inst, uint32_t data) {
